    ...
    if (analyzeButton && urlInput && window.electron && window.electron.analyzeUrl) {
      analyzeButton.addEventListener('click', async () => {
        ...
        try {
          ...
          if (msg && (
            msg.includes('The provided YouTube account cookies are no longer valid') ||
            msg.includes('Sign in to confirm you') ||
            msg.includes('how to manually pass cookies') ||
            msg.includes('Use --cookies-from-browser') ||
            msg.includes('exporting-youtube-cookies') ||
            msg.includes('Sign in to confirm you’re not a bot') ||
            msg.includes('Sign in to confirm you’re not a robot')
          )) {
